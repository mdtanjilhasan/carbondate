...
var _timezone2 = _interopRequireDefault(require("dayjs/plugin/timezone"));
...
function _assertClassBrand(e, t, n) { if ("function" == typeof e ? e === t : e.has(t)) return arguments.length < 3 ? t : n; throw new TypeError("Private element is not present on this object"); } // Import plugins
// Register the plugins
_dayjs["default"].extend(_utc["default"]);
_dayjs["default"].extend(_timezone2["default"]);
...
var CarbonDate = exports["default"] = /*#__PURE__*/function () {
  function CarbonDate() {
  ...
  return _createClass(CarbonDate, [{
    key: "now",
    value: function now() {
      this.value = (0, _dayjs["default"])().tz(this.timezone);
      return this;
    }
  }, {
    key: "format",
    ...
    value: function parse(dateTimeString) {
      ...
      if (!dateTime) {
        ...
        if (convert) {
          this.value = (0, _dayjs["default"])(newDateTimeString).tz(this.timezone);
        } else {
          this.value = (0, _dayjs["default"])(newDateTimeString);
        }
      }
      return this;
    }
    ...
    value: function currentTimezone() {
      this.value = import.meta.env.APP_TIMEZONE ? import.meta.env.APP_TIMEZONE : _dayjs["default"].tz.guess();
      return this;
    }
  }, {
    key: "diffInDays",
    ...
    function diffInDays(date) {
      ...
      if (!_dayjs["default"].isDayjs(currentVal)) {
        throw new Error('Invalid Object Type.');
      }
      var diffDate = date !== null && date !== void 0 && date.value ? date.value : date;
      if (!_dayjs["default"].isDayjs(diffDate)) {
    ...
    value: function inBetween(start, end) {
      ...
      if (!_dayjs["default"].isDayjs(startDate)) {
    ...
    value: function diffForHumans() {
      ...
      if (!_dayjs["default"].isDayjs(fromDate)) {
...
function _getValidData(value) {
  ...
  try {
    ...
    if (_dayjs["default"].isDayjs(dateTimeString)) {
    ...
    if (_assertClassBrand(_CarbonDate_brand, this, _isDate).call(this, dateTimeString)) {
      dateTimeString = (0, _dayjs["default"])(dateTimeString).format('YYYY-MM-DD HH:mm:ss');
    }
...
function _setTimeZone(timezone) {
  ...
  if (timezone) {
    ...
    this.timezone = import.meta.env.APP_TIMEZONE ? import.meta.env.APP_TIMEZONE : _dayjs["default"].tz.guess();
  }
}
